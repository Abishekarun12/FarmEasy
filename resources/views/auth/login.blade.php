<x-guest-layout>
 ...
 {{-- <div style="background-image: url('{{ asset('images/1676902767_WhatsApp Image 2022-12-26 at 11.38.48 PM.jpeg') }}');background-size: cover;"
  class="font-sans min-h-screen antialiased pt-24 pb-5"> --}}
          ...
          <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="flex flex-col bg-white p-10 rounded-lg shadow space-y-6">
              ...
              <div class="flex flex-col-reverse sm:flex-row sm:justify-between items-center">
                ...
                <button type="submit" class="bg-green-500 text-white font-bold px-5 py-2 rounded focus:outline-none shadow hover:bg-yellow-700 transition-colors m-auto">Log In</button>
              </div>
            </div>
          </form>
